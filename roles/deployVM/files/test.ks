...
# Network information
network --bootproto=static --activate --device=eth0 --ip=192.168.10.34 --netmask=255.255.255.0 --gateway=192.168.10.1 --nameserver=192.168.10.10,192.168.10.1 --vlanid=10 --interfacename=eth0.10
network  --hostname=test.webux.lab
